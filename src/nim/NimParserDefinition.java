...
public class NimParserDefinition implements ParserDefinition {
    ...
    public static final IFileElementType FILE = new IFileElementType(Language.<NimLanguage>findInstance(NimLanguage.class));

    @NotNull
    @Override
    public Lexer createLexer(Project project) {
        return new FlexAdapter(new NimLexer((Reader) null));
    }
